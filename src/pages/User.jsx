      ...
      <div className='w-full mx-auto lg:w-10/12'>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8'>
          <div className='custom-card-image mb-6 md:mb-0'>
            <div className='rounded-lg shadow-x card image-full'>
              <figure>
                <img src={avatar_url} alt={`The photo of ${user.name}`} />
              </figure>
        ...
        <div className='w-full py-5 mb-6 rounded-lg bg-base-100 stats shadow-md'>
          <div className='stat'>
